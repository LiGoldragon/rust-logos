//! The writer: EncodedLogos → Rust token structure.
//!
//! One domain trait, [`ProjectRust`], implemented once per EncodedLogos node kind —
...
use core_logos::{
    ...
    Parameter, PathNode, Pattern, PatternElement, QualifiedPath, RangeExpression, Receiver,
...
/// The single projection verb, implemented once per EncodedLogos node kind. Returns a
...
impl RustSource {
    ...
    /// Project one EncodedLogos item to byte-exact Rust: assemble its token structure
